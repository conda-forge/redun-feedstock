...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/redun-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15071&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/redun-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `redun` can be installed with:

```
conda install redun
```

It is possible to list all of the versions of `redun` available on your platform with:
